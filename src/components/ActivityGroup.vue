<template lang="html">
  <div class="activity-group">
    ...
    <CandleRow v-for="(candle, ix) in activity.candles" :theme="theme" :candle="candle" :key="`${activity.id}-${ix}-candle`" :actId="`${activity.id}-${ix}-candle`" v-on:candle-correct="checkCandles($event, ix)"/>
