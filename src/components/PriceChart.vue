  ...
  <div class="col-sm-12">
    ...
    <svg id="pchart" width="100%" v-bind:height="88 + ((pcdata.prices.length - 1) * 40)">
      <g>
        ...
        <!-- Time Interval Lines -->
        <line v-for="(time,index) in pcdata.timeIntervals" :key="'tline-' + index" v-bind:x1="70 + (40 * index)" v-bind:y1="58 + (40 * (pcdata.prices.length - 1))" v-bind:x2="70 + (40 * index)" v-bind:y2="50 + (40 * (pcdata.prices.length - 1))"
          class="chart-tline" />
