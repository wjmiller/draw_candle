<template lang="html">
  <div class="feedback">
    <b-button variant="primary" :disabled="!active" @click="revealFeedback()">{{buttonTitle}}</b-button>
    <div>
      <div class="feedback-display" v-bind:class="{'correct': (correct && revealed)}">
          <div class="feedback-message" v-if="revealed">
            <div class="feedback-correct" v-if="correct && revealed">
              <img v-if="theme == 'dark'" class="animate-zoom" src="../assets/images/icons/checkmark.svg"/>
              <img v-else class="animate-zoom" src="../assets/images/icons/checkmark_green.svg"/>
            </div>
